...
<p align="left">
  I'm <strong>Ankit Kumar</strong>, a passionate <strong>Platform Engineer</strong> from Delhi, India 🇮🇳
</p>

<h2 align="left">🧑‍💻 About Me</h2>

<ul align="left">
  <li>🛠️ I'm a Platform Engineer passionate about building scalable, secure, and automated infrastructure for modern applications</li>
  <li>💻 I work across the stack – from frontend UIs to backend services and DevOps pipelines</li>
  <li>🌱 I’m currently learning <strong>LangChain</strong> for building AI-integrated workflows and <strong>Terraform</strong> for infrastructure as code</li>
  <li>📚 I enjoy bridging the gap between software development and cloud infrastructure</li>
  <li>🎯 Goals: Architect cloud-native systems, improve platform reliability, and contribute to open-source tooling</li>
  <li>🎲 Fun fact: I once automated my system setup so well I forgot how to do it manually 😄</li>
</ul>
